...
public partial class UberSystemDbContext : DbContext
{
  ...
  /*  private string GetConnectionString()
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=(local);Initial Catalog=UberSystem;User ID=sa;Password=12345;Connect Timeout=30;Encrypt=True;Trust Server Certificate=True;Application Intent=ReadWrite;Multi Subnet Failover=False");
        }
    }
